...
| Lan / Wan | Local Area Network which is computers connected to eachother that can only talk to eachother. Wide Area Network which is when a router is used to connect to the internet. |
